...
public class TelaDeLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            ...
            /*
        for (Cliente cli : this.listaC) {
            if (cli.getAcesso().getLogin().equals(txtNome.getText()) && cli.getAcesso().getSenha().equals(txtSenha.getText())) {
                nome = txtNome.getText();
                senha = txtSenha.getText();
                TelaDoCliente tc = new TelaDoCliente(this, true);
                tc.setVisible(true);
        ...
        for (Treinador tre : this.listaT) {
            if (tre.getAcesso().getLogin().equals(txtNome.getText()) && tre.getAcesso().getSenha().equals(txtSenha.getText())) {
                senha = txtSenha.getText();
                nome = txtNome.getText();
                TelaDoTreinador tr = new TelaDoTreinador(this, true);
                tr.setVisible(true);
